      ...
      <Modal.Body>
        <form onSubmit={onSubmit}>
          ...
          <div className="row media-flex-col">
            <div className="col">
              <div className="form-group ">
                ...
                <input
                  ...
                  defaultValue={
                    mode == "edit" ? data.PrivateTechnicalK_Price : ""
                  }
                />
              </div>
            </div>
            ...
            <div className="col">
              <div className="form-group ">
                <label className="lblAbs font-12">مبلغ K حرفه ای-خصوصی</label>
                <input
                  type="number"
                  className="form-control floating inputPadding rounded"
                  name="ppk_price"
                  ...
                  defaultValue={
                    mode == "edit" ? data.PrivateProfessionalK_Price : ""
                  }
                />
              </div>
            </div>
            ...
            <div className="col">
              <div className="form-group ">
                ...
                <input
                  ...
                  defaultValue={
                    mode == "edit" ? data.GovernmentalTechnicalK_Price : ""
                  }
                />
              </div>
            </div>
            ...
            <div className="col">
              <div className="form-group ">
                <label className="lblAbs font-12">مبلغ K حرفه ای-دولتی </label>
                <input
                  type="number"
                  className="form-control floating inputPadding rounded"
                  name="gpk_price"
                  ...
                  defaultValue={
                    mode == "edit" ? data.GovernmentalProfessionalK_Price : ""
                  }
                />
              </div>
            </div>
